package wy.morphe.patches.klwp

import app.morphe.patcher.extensions.InstructionExtensions.addInstructions
import app.morphe.patcher.patch.bytecodePatch
import wy.morphe.patches.shared.Constants.KLWP_COMPATIBILITY

@Suppress("unused")
val klwpPatch = bytecodePatch(
    name = "Pro",
    description = "Enable pro",
) {
    compatibleWith(KLWP_COMPATIBILITY)
